...
- Frontend note: local signup no longer asks users for provider keys. Generation uses the sample fixture instead of a live LLM call when the fixture exists.
